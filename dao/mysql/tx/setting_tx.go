...
func (store *MySQLDB) AddSettingWithTx(ctx context.Context, rdb *operate.RDB, accountID, relationID int64, isLeader bool) error {
...
func (store *MySQLDB) TransferGroupWithTx(ctx context.Context, accountID, relationID, toAccountID int64) error {
	return store.execTx(ctx, func(queries *db.Queries) error {
		var err error
...
func (store *MySQLDB) DeleteSettingWithTx(ctx context.Context, rdb *operate.RDB, accountID, relationID int64) error {
	return store.execTx(ctx, func(queries *db.Queries) error {
